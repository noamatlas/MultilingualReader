...
export default function App() {
  ...
  }, [vocab, translationCache, romanizationCache, etymologyCache, inputText, library, currentLang, isInitialized, audioSpeed]);
      ...
      >
        <div className="flex flex-col sm:flex-row items-center gap-3 w-full md:w-auto justify-between md:justify-start">
          ...
          <div className="flex items-center gap-3 w-full sm:w-auto justify-between">
            ...
            {currentLang && (
              <div className="flex items-center gap-2 bg-blue-800 px-3 py-2 rounded-lg border border-blue-600 w-full sm:w-auto">
