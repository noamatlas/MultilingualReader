...
export default function App() {
  ...
  const parseTeacherResponse = (rawText) => {
     ...
     return { feedback: "", hiddenTarget: "", message: rawText, currentSentence: "", task: "", isCorrect: null };
  };
  ...
  const getActivitySystemInstruction = (mode) => {
    ...
    if (mode === 'translation') {
       ...
       2. If the user was INCORRECT, keep the previous 'currentSentence' and repeat the 'task' (perhaps adding a hint).
       ...
       4. Generate a NEW 'task' IN ENGLISH. Instruct the user to modify the 'currentSentence' using ONE element from this Linguistic Variation Taxonomy: TAM (Tense/Aspect/Mood), Voice/Polarity, Nominal Categories (Number/Gender/Case), Modification (Adjectives/Adverbs), Syntax (Word order/Clauses), Pragmatics (Formality/Synonyms).
       5. Put the exact expected target sentence in 'hiddenTarget' (IN ${currentLang.name.toUpperCase()}).`;
    } else {
    ...
    if (mode === 'variation_lab') {
       sysInstruction += `\n\n5. You MUST ALWAYS return ONLY a valid JSON object with EXACTLY these keys (do NOT add "thought" or any extra keys):
       {
         ...
         "task": "The instruction IN ENGLISH of what to change",
                                       ...
                                       <div className="w-full max-w-2xl bg-white rounded-2xl border border-indigo-100 shadow-sm p-5 md:p-8 relative mt-4">
                                           ...
                                           {msg.hiddenTarget && (
                                               <div className="mt-5 flex flex-col items-center">
                                                   ...
                                                   {msg.isHintOpen && (
                                                       <div className="mt-3 bg-amber-50 text-amber-800 border border-amber-200 px-4 py-2 rounded-xl text-md font-bold shadow-sm" dir={isRTL ? "rtl" : "ltr"}>
                                                           {msg.hiddenTarget}
                                                       </div>
                                                   )}
                                               </div>
