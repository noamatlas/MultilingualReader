...
import { BookOpen, Edit3, Download, Upload, Volume2, CheckCircle, Clock, X, Globe, AlignLeft, Sparkles, StopCircle, BookA, Languages, Undo2, Search, ArrowDown, GraduationCap, Library, Save, Trash2, BookMarked, ChevronLeft, ChevronRight, Plus, Eye, EyeOff, MessageCircle, Send, Lightbulb, Minimize, Maximize, ChevronFirst, ChevronLast, LayoutList } from 'lucide-react';
...
export default function App() {
  ...
  return (
    ...
    >
      ...
      {(selectedWords.length > 0 || showFullTranslationToggle || infoPopup || showPPS) && currentLang && (isReading || isChatOpen) && (
        <div 
